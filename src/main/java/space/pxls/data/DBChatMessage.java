...
public class DBChatMessage {
    ...
    public DBChatMessage(int id, int author_uid, Long sent, String content, String filtered_content, int replying_to_id, boolean purged, int purged_by_uid, String purge_reason, boolean author_was_shadow_banned) {
        this.id = id;
